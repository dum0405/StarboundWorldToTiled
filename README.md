...
# 5. When you run the script, a JSON file compatible with the 'Tiled' program will be generated using the specified world_name as the file name.
Additionally, a generated tileset may also be created if needed.
